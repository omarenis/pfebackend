...
function j(t,e,o,i){
    ...
    {
        void 0===p&&(p=x);
        let f=x-p;f>=e?(t.style.overflow="",
        i||(t.style.display="none"),
        "function" === typeof o&&o(),
        t.style.height="", t.style.paddingTop="",t.style.paddingBottom="",t.style.marginTop="",
        t.style.marginBottom=""):window.requestAnimationFrame(l),
        i?(t.style.height=g*f+"px",
        t.style.paddingTop=y*f+"px",
        t.style.paddingBottom=m*f+"px",
        t.style.marginTop=u*f+"px",
        t.style.marginBottom=h*f+"px"):(t.style.height=n-g*f+"px",t.style.paddingTop=a-y*f+"px",t.style.paddingBottom=s-m*f+"px",
